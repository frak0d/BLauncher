...
class Ui(QtWidgets.QMainWindow):
    ...
    def fixf(self):
        print('Crash Fixing...')
        cmd('powershell -Command "Disable-WindowsErrorReporting"')
    ...
    def stopf(self):
        cmd(
            'Reg.exe add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\ClipSVC\Parameters" /v "ServiceDll" /t REG_EXPAND_SZ /d "%%SystemRoot%%\System32\ClipSVC.dll" /f')
        if x == 1:
